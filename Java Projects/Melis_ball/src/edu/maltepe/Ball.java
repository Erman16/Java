...
public class Ball{
     ...
     */
    public void moveOneStepWithCollisionDetection1(ContainerBox box) {
        ...
        if (x < ballMinX) {
            ...
            x = ballMinX;
            BallWorld.ballList2.add(this);
            BallWorld.ballList1.remove(this);
        }
    ...
    public void moveOneStepWithCollisionDetection2(ContainerBox box) {
        // Get the ball's bounds, offset by the radius of the ball
        float ballMinX = box.minX + radius;
        float ballMinY = box.minY + radius;
        float ballMaxX = box.maxX - radius;
        ...
        if (x < ballMinX) {
          // Reflect along normal
            ...
            BallWorld.ballList1.add(this);
            BallWorld.ballList2.remove(this);
        } else if (x > ballMaxX) {
            speedX = -speedX;
            x = ballMaxX;
        }
