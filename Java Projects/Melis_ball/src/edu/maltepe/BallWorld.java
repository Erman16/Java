...
public class BallWorld extends JPanel {
     ...
     */
    public BallWorld(int width, int height,int worldcontroll) {

        canvasWidth = width;
        canvasHeight = height;
        this.worldcontroll = worldcontroll;
        ...
        int size = rand1.nextInt(0,20);

        if(worldcontroll == 1){
            for(int i=0;i<=size;i++){
                Random rand2=new Random();
                int size2=rand1.nextInt(0,3);

                if(size2==2){
                    ballList1.add(new Ball(x, y, radius, speed+i, angleInDegree+(i*4), Color.red));
                }
            }
        }
        ...
        if(worldcontroll == 2){
            for(int i=0;i<=size;i++){
                ...
                if(size2==2){
                    ballList2.add(new Ball(x, y, radius, speed+i, angleInDegree+(i*4), Color.blue));
                }
            }
        }
//
